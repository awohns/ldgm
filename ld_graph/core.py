...
def brick_graph(brick_ts, use_rule_three=False):
    """
    Make a brick graph
    """
    brick_grapher = bricks_graph.BrickGraph(brick_ts, use_rule_three=use_rule_three)
...
def brick_descendants(ts):
    return utility.get_brick_descendants(ts)
